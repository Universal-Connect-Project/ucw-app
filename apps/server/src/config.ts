...
const keysToPullFromEnv = [
  ...
  "PLAID_SECRET",
  "PLAID_SECRET_PROD",
  "ENABLE_INSECURE_PLAID_ADAPTER",

  "FLINKS_INSTANCE",
  "FLINKS_CUSTOMER_ID",
  "FLINKS_API_KEY",

  "FLINKS_INSTANCE_PROD",
  "FLINKS_CUSTOMER_ID_PROD",
  "FLINKS_API_KEY_PROD",
  ...
  "CONNECTION_EXPIRATION_MINUTES",
  "EXPIRED_CONNECTION_CLEANUP_POLLING_INTERVAL_MINUTES",
];
