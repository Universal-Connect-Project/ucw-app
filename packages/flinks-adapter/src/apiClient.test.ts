...
const apiClient = new FlinksClient(
  false,
  { flinksSandbox: mockApiCredentials, flinksProd: mockApiCredentials },
  logger,
  mockEnvConfig,
...
describe("FlinksClient", () => {
  ...
  describe("getAuthToken", () => {
    it("retrieves and caches the token", async () => {
      ...
      const cachedToken = await cacheClient.get(FLINKS_TOKEN_REDIS_KEY);
