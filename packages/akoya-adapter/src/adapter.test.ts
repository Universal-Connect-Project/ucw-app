...
const oauth_window_uri_example = 'https://idp.ddp.akoya.com/auth?connector=testInstitutionId&client_id=undefined&redirect_uri=undefined/oauth/akoya/redirect_from&state=test-session123456789&response_type=code&scope=openid profile offline_access'
